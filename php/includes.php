...
if (basename($_SERVER['PHP_SELF'])!="login.php" && basename($_SERVER['PHP_SELF']) !="ajax.php" && (!isset($_SESSION['uid']) || $_SESSION['uid']<1 || !isset($_SESSION['group_id']) || $_SESSION['group_id']<0))
{
